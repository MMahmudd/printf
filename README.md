...
This team project is a redo of the printf function for the C programming language called \_printf. It takes variable inputs and arguments just like the standard library function printf. This work was done by Christian Solomon and Mahmud Mohammed Adem Mohammed.

## **SYNOPSIS**
The **\_printf()** function writes output to standard output with the format and options without the help of any of the standard libraries. It uses a local buffer of 1024bytes when writing.

\_printf() returns the total number of characters printed to the standard out.

If there is an output error, -1 is returned.
...
\_Christian Solomon
>
\_Mohammed Mahmud Adem Mohammed
